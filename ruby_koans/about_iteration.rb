...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # If you specify a symbol instead, then each element in th
    # e collection will be passed to the named method of memo. In
    # either case, the result becomes the new value for memo. At the
    # end of the iteration, the final value of memo is the return
