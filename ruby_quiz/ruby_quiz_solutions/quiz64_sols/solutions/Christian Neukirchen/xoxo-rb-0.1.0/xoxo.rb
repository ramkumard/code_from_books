#
# xoxo.rb -- a Ruby XOXO parser and generator
#
# Copyright (C) 2006  Christian Neukirchen <chneukirchen@gmail.com>
#
...
# XOXO provides a Ruby API similar to Marshal and YAML (though more
