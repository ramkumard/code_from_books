...
whiskey_bottle = Thing.new { | o |
  ...
  o.long_desc = "A half-full bottle of Old Throat Ripper. The label claims it's \"the finest whiskey sold\" and warns that \"multiple applications may be required for more than three layers of paint\"."
}
...
class << $world
  ...
  def can_perform(verb, words, room_symbol, subj_needed, obj_needed, need_obj,
    ...
    puts "You can't #{verb} like that." unless ok || !verbose
    return ok
  end
