module LCD
  ...
  # Digits are represented by simple bit masks. Each bit identifies whether a line
  # should be displayed or not. The following ASCII graphic shows the mapping from
  # bit position to the belonging line.
  #
  #  =6
  # 5  4
  #  =3
